...
public class GFF3FileConfig {
	...
	public static AnnotationMethod getAnnotationMethod(EntityFactory<?,?,?,?> factory, String type, String source)
	{
	...
	public static AnnotationMethod getAnnotationMethod(EntityFactory<?,?,?,?> factory,
			GFF3Record record) {
