...
public class GBKFileConfig {
	...
	public static ArrayList<Pattern> getPatternsByType(String parameterName, String type) {
		parameterName = "gbk.file." + parameterName;
	...
	public static final String										geneType			= getStringMandatory("gbk.file.typeValue.gene");
	public static final String										cdsType				= getStringMandatory("gbk.file.typeValue.cds");
	public static final String										mrnaType			= getStringMandatory("gbk.file.typeValue.mrna");
	...
	public static ArrayList<String> getParentDbNames(String type) {
		return getStringsType("parentDbName", true, type, parentDbNames);
	}
