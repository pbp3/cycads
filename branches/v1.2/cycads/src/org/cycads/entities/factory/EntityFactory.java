...
public interface EntityFactory<X extends Dbxref, M extends AnnotationMethod, T extends Type, O extends Organism< ? , ? >, F extends Function, E extends EntityObject, A extends Annotation< ? , ? >>
