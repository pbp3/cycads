...
public interface AssociationFinder
{
	...
	public <SO extends AssociationObject, TA extends AssociationObject> Collection< ? extends Association< ? extends SO, ? extends TA>> getAssociations(
			SO source, TA target, Collection<Type> types, Dbxref synonym);

	/* The arguments nulls are not considerated */
	public <TA extends AssociationObject> Collection< ? extends Association< ? , ? extends TA>> getAssociations(
			Type sourceType, TA target, Collection<Type> types, Dbxref synonym);

	/* The arguments nulls are not considerated */
	public <SO extends AssociationObject> Collection< ? extends Association< ? extends SO, ? >> getAssociations(
