...
import org.cycads.extract.cyc.ByLineTextStream;
...
public class AnnotationGenerator
{
	...
	public static void main(String[] args) {
		...
		// add by PBP, for further exported file format option
		int fileFormatOption = Tools.getInteger(args, 6, Config.defaultFileFormat(), Messages.AnnotationGeneratorChooseFileFormatOption());
		...
		try {
			...
			switch (fileFormatOption){
				...
				case 2: //TxtByLine
					{
						outStream = new ByLineTextStream(file, Config.pfGeneratorFileHeader());
						break;

					}
				case 3: //TxtByFunction
					{
						outStream = new ByLineTextStream(file, Config.pfGeneratorFileHeader());
						break;
					}
